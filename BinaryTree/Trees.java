...
//The root node does not have a parent and every tree can have only parent
 //A leafe node has no children
 //A singelton tree has only one node - the root
 //Every tree consists of one or more subtrees
 //You cant have a path that crosses a node more than once
